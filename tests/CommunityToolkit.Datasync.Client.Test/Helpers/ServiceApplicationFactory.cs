...
public class ServiceApplicationFactory : WebApplicationFactory<Program>
{
    ...
    internal string KitchenSinkEndpoint = "http://localhost/api/in-memory/kitchensink";
    internal string MovieEndpoint = "http://localhost/api/in-memory/movies";
    internal string PagedMovieEndpoint = "http://localhost/api/in-memory/pagedmovies";
    internal string SoftDeletedMovieEndpoint = "http://localhost/api/in-memory/softmovies";
